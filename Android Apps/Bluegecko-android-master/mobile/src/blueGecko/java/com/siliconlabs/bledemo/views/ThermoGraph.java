...
public class ThermoGraph extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < NUM_BARS; i++) {
            ...
            //TODO: temporary
            tempViews[i].setTemperature(new TemperatureReading(TemperatureReading.Type.FAHRENHEIT, 80d, System.currentTimeMillis(), TemperatureReading.HtmType.UNKNOWN, (short)7,(short)8,(short)9, (int)0));
